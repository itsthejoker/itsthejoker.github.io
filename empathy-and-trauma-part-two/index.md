...
The ones who feel like they don't belong.[^olderpatients]
...
[^olderpatients]:
    Side note: if a patient somehow survives a condition with an extraordinarily high mortality rate as a child, all of the doctors that know how to work with their condition only work at the children's hospital. I've worked with several patients in their 30s and 40s during their stays at the hospital; we have no rooms that are set aside for different ages, so their rooms are mixed in with everyone else. They're always good sports about it, though.
